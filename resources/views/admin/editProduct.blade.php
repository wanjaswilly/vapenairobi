...
<div class="d-flex align-items-center justify-content-center">
    <div class="col-sm-6 mt-5 mb-4">
        <form action="{{route('products.update', $product->id)}}" method="POST" autocomplete="off">
            ...
            <div data-mdb-input-init class="form-outline">
                <input type="text" id="productQuantity" name="productQuantity" value="{{$product->productQuantity}}"
                    class="form-control" required />
            ...
            <div data-mdb-input-init class="form-outline mt-4">
                <input type="text" id="productFlavours" name="productFlavours"
                    value="{{implode(",", json_decode($product->productFlavours))}}" class="form-control" required />
            ...
            <div data-mdb-input-init class="form-outline mb-4 mt-4">
                <input type="text" id="productManufacturer" name="productManufacturer"
                    value="{{$product->productManufacturer}}" class="form-control" />
            ...
            <div data-mdb-input-init class="form-outline mb-4">
                <input type="text" id="productShortDescription" name="productShortDescription"
                    value="{{$product->productShortDescription}}" class="form-control" />
            ...
            <div data-mdb-input-init class="form-outline mb-4">
                <textarea class="form-control" id="productLongDescription" name="productLongDescription"
                    rows="8">{!! $product->productLongDescription !!}</textarea>
                <label class="form-label" for="productLongDescription">Additional information</label>
            </div>

            <!-- Submit button -->
            <button data-mdb-ripple-init type="submit" class="btn btn-primary ">Save</button>
        </form>
    </div>
</div>
